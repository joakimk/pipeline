...
* Persistence
  ...
  - Extracted base code: [lib/minimapper](https://github.com/joakimk/deployer/tree/master/lib/minimapper) (in the process of being [made into a gem](https://github.com/joakimk/minimapper))
* Testing
